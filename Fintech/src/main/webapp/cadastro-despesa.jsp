...
<div class="container">
	...
	<form action="despesa" method="post">
		...
		<div class="form-group">
			...
			<input type="text" name="contas" id="id-contas" class="form-control">
		</div>
		<div class="form-group">
			<label for="id-produtos">Produtos</label>
			<input type="text" name="produtos" id="id-produtos" class="form-control">
		</div>
		<div class="form-group">
			<label for="id-lazer">Lazer</label>
			<input type="text" name="lazer" id="id-lazer" class="form-control">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" name="total" id="id-extra" class="form-control">
		</div>
